        ...
        <div className="max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm ml-2" style={{color: '#15803d'}}>4.5 on Google</span>
            </div>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{color: '#6b7280'}}>
              Experience world-class dental care at Hyderabad Dental Care. Expert dentists, modern technology, and compassionate care.
            </p>
